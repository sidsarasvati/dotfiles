"""
Gemini Image Generation Library - High-level interface for image generation.

Usage:
    from gemini_images import GeminiImageGenerator

    gen = GeminiImageGenerator()
    gen.generate("A cat in space", "cat.png")
    gen.edit("input.png", "Add stars", "output.png")
"""
...
class GeminiImageGenerator:
    ...
    def _build_config(
        ...
        if img_config:
            kwargs["image_generation_config"] = img_config
